...
public record ConceptChangeHistoryResponse(
    ...
    public ConceptChangeHistoryResponse {
        conceptChanges = conceptChanges == null ? null : List.copyOf(conceptChanges);
        semanticChanges = semanticChanges == null ? null : List.copyOf(semanticChanges);
    }
    ...
    public record SemanticChangeHistory(
        ...
        public SemanticChangeHistory {
            versionChanges = versionChanges == null ? null : List.copyOf(versionChanges);
        }
    }
    ...
    public record VersionChange(
        ...
        public VersionChange {
            fieldChanges = fieldChanges == null ? null : List.copyOf(fieldChanges);
        }
    }

...
public record StampCoordinateDto(
    ...
    public StampCoordinateDto {
        moduleIds = moduleIds == null ? null : List.copyOf(moduleIds);
        excludedModuleIds = excludedModuleIds == null ? null : List.copyOf(excludedModuleIds);
        modulePriorityIds = modulePriorityIds == null ? null : List.copyOf(modulePriorityIds);
    }
}
